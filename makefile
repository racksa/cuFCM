...
FLOWFIELD_FILES = CUFCM_FLOWFIELD_MAIN.cu CUFCM_CELLLIST.cu CUFCM_FCM.cu CUFCM_DATA.cu CUFCM_CORRECTION.cu CUFCM_SOLVER.cu
...
FLOWFIELD : $(FLOWFIELD_FILES)
	nvcc $^ -DEVALUATE_FLOWFIELD -DUSE_REGULARFCM $(NVCC_FLAGS) $(LINK) -o bin/$@
